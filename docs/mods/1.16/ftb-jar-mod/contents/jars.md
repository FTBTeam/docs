...
![Empty Glass Jar](./images/glass-jar.png "Empty Glass Jar")
...
![Filled Jars](./images/filled-glass-jars.png "Filled Jars")
...
![Glass Jar with Tubes](./images/glass-jar-and-tube.png "Glass Jar with Tubes")

Glass Jars do not retain their contents when broken. They really are meant only for providing fluids for crafting!

![Breaking Glass Jar](./images/glass-jar-breaking.gif "Breaking Glass Jar")
...
![Tempered Glass Jar](./images/tempered-glass-jar.png "Tempered Glass Jar")

Tempered Glass Jars, like Glass Jars, also connect to Iron Cast Tubes only at the top where the cork is.

![Tempered Glass Jar with Tubes](./images/tempered-glass-jar-and-tube.png "Tempered Glass Jar with Tubes")
...
![Example Setup](./images/simple-setup.png "Example Setup")
...
![Graphical User Interface](./images/sample-gui.png "Graphical User Interface")
...
![Example Craft](./images/sample-recipe.gif "Example Craft")
...
|:--:|:--:|:--:|
| None | ![None](./images/temperature-none.png "None") | ![None](./images/tempered-glass-jar-none.png "None") |
| Low | ![Low](./images/temperature-low.png "Low") | ![Low](./images/tempered-glass-jar-low.png "Low") |
| High | ![High](./images/temperature-high.png "High") | ![High](./images/tempered-glass-jar-high.png "High") |
| Sub-Zero | ![Sub-Zero](./images/temperature-subzero.png "Sub-Zero") | ![Sub-Zero](./images/tempered-glass-jar-subzero.png "Sub-Zero") |
...
|:--:|:--:|:--:|:--:|
| `minecraft:respawn_anchor` | 8.0x | ![Respawn Anchor](./images/built-in/none-1.png "Respawn Anchor") | `ftbjarmod:temperature_sources/respawn_anchor` |
| `minecraft:glowstone` | 1.25x | ![Glowstone](./images/built-in/none-2.png "Glowstone") | `ftbjarmod:temperature_sources/glowstone_block` |
| `minecraft:crying_obsidian` | 3.0x | ![Crying Obsidian](./images/built-in/none-3.png "Crying Obsidian") | `ftbjarmod:temperature_sources/crying_obsidian` |
| Any Block | 1.0x | ![Any Block](./images/built-in/none-4.png "Any Block") | No ID, cannot be changed |
| `minecraft:torch` & `minecraft:wall_torch` | 0.25x | ![Torch](./images/built-in/low-1.png "Torch") | `ftbjarmod:temperature_sources/torch` & `ftbjarmod:temperature_sources/wall_torch` |
| `minecraft:fire` | 0.75x | ![Fire](./images/built-in/low-2.gif "Fire") | `ftbjarmod:temperature_sources/fire` |
| `minecraft:lava` | 4.0x | ![Lava](./images/built-in/low-3.png "Lava") | `ftbjarmod:temperature_sources/lava` |
| `minecraft:campfire` | 0.5x | ![Campfire](./images/built-in/low-4.png "Campfire") | `ftbjarmod:temperature_sources/campfire` |
| `minecraft:magma_block` | 0.5x | ![Magma Block](./images/built-in/low-5.png "Magma Block") | `ftbjarmod:temperature_sources/magma_block` |
| `minecraft:soul_fire` | 0.75x | ![Soul Fire](./images/built-in/high-1.gif "Soul Fire") | `ftbjarmod:temperature_sources/soul_fire` |
| `minecraft:beacon` | 4.0x | ![Beacon](./images/built-in/high-2.png "Beacon") | `ftbjarmod:temperature_sources/beacon` |
| `ftbjarmod:blue_magma_block` | 1.0x | ![Blue Magma Block](./images/built-in/high-3.png "Blue Magma Block") | `ftbjarmod:temperature_sources/blue_magma_block` |
| `minecraft:soul_campfire` | 0.5x | ![Soul Campfire](./images/built-in/high-4.png "Soul Campfire") | `ftbjarmod:temperature_sources/soul_campfire` |
