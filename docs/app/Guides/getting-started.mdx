...
<div>
    ...
    ![Preview of what it looks like to be logged in](../_assets/images/ftb-app-login-preview.webp)
    ...
    ![The update notification on the app](../_assets/images/ftb-app-updating.webp)
    ...
    ![The settings page](../_assets/images/ftb-app-instance-settings-page.webp)
