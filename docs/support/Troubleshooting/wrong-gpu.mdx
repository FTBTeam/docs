...
description: If Minecraft is using the wrong GPU, here are some steps you can take to fix the issue.
sidebar_position: 4
tags:
  - Support
  - Troubleshooting
...
<Tabs>
    <TabItem value="nvidia" label="NVIDIA">
        ...
        ![Win Start](../_assets/images/wrong-gpu/click-on-start.webp)

        2. Search for `NVIDIA Control Panel` and open it.

        ![Search NVIDIA Control Panel](../_assets/images/wrong-gpu/start-nv-panel.webp)
        ...
        ![Click Manage 3D Settings](../_assets/images/wrong-gpu/nv-cp-program-tab.webp)
        ...
        ![Click Apply](../_assets/images/wrong-gpu/nv-cp-apply.webp)
    </TabItem>
