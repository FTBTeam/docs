...
The Ready to Redeem menu appears on the main Quest Book screen when you have completed quests with unclaimed rewards.

Open it to see all completed quests across every chapter. Tap a quest to claim it, or use the **Redeem All** button to collect everything at once.
